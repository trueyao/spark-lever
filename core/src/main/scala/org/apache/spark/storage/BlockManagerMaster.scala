...
class BlockManagerMaster(
  ...
  /** Get ids of other nodes in the cluster from the driver 此处的driver是指BlockManagerMasterActor*/
  ...
  def getBlockManagerIdForHost(host: String): Seq[BlockManagerId] = {
    ...
    logInfo("Get all block manager Id for host " + host + ":" + allBlockManagerId)
    allBlockManagerId
  }
